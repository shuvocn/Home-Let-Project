...
public partial class Default2 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            else if (Session["B"] != null)
            {

                MySqlDataAdapter da = new MySqlDataAdapter("select p_image,p_area,p_address,p_description,p_price,p_type,p_bed,p_bath from add_property where p_type='" + "Bachalor" + "' order by p_id desc", con);
                DataTable dt = new DataTable();
                con.Open();
                da.Fill(dt);
            ...
            else if (Session["S"] != null)
            {
                ...
                MySqlDataAdapter da = new MySqlDataAdapter("select p_image,p_area,p_address,p_description,p_price,p_type,p_bed,p_bath from add_property where p_type='" + "Sublet" + "' order by p_id desc", con);
                DataTable dt = new DataTable();
                con.Open();
                da.Fill(dt);
            ...
            else if (Session["M"] != null)
            {
                ...
                MySqlDataAdapter da = new MySqlDataAdapter("select p_image,p_area,p_address,p_description,p_price,p_type,p_bed,p_bath from add_property where p_type='" + "Female Mess" + "' order by p_id desc", con);
                DataTable dt = new DataTable();
                con.Open();
                da.Fill(dt);
            ...
            else if (Session["H"] != null)
            {
                ...
                MySqlDataAdapter da = new MySqlDataAdapter("select p_image,p_area,p_address,p_description,p_price,p_type,p_bed,p_bath from add_property where p_type='" + "Hostel" + "' order by p_id desc", con);
                DataTable dt = new DataTable();
                con.Open();
                da.Fill(dt);
            ...
            else if (Session["O"] != null)
            {
               
                MySqlDataAdapter da = new MySqlDataAdapter("select p_image,p_area,p_address,p_description,p_price,p_type,p_bed,p_bath from add_property where p_type='" + "Office Space" + "' order by p_id desc", con);
                DataTable dt = new DataTable();
                con.Open();
                da.Fill(dt);
    ...
    protected void Result_Page(object sender, CommandEventArgs e)
    {
        ...
        Response.Redirect("SearchPropertyResult.aspx");
    }
}