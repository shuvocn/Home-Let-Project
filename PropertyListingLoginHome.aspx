<%@ Page Title="" Language="C#" MasterPageFile="~/LoginMasterPage.master" AutoEventWireup="true" CodeFile="PropertyListingLoginHome.aspx.cs" Inherits="Default2" %>
                    ...
                    <div class="propertyItem">
                        <div class="propertyContent row">
                            <div class="col-lg-4 col-md-4 col-sm-4">
                                ...
                                <asp:Label ID="Label7" runat="server" Text='<%# Eval("p_type") %>'></asp:Label>
                                </a>
                                <a class="propertyImgLink" href="SearchPropertyResult.aspx">
                            ...
                            <div class="col-lg-8 rowText" >
                                ...
                                <br />
                                <p>
                                    <asp:Label ID="Label5" runat="server" Text='<%# Eval("p_description") %>' CssClass="description" Width="550px"></asp:Label>
                                </p>
