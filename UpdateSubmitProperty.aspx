<%@ Page Title="" Language="C#" MasterPageFile="~/LoginMasterPage.master" AutoEventWireup="true" CodeFile="UpdateSubmitProperty.aspx.cs" Inherits="Default2" %>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 col-lg-offset-4 col-md-4">
                <div class="formBlock">
                    <asp:Button ID="Button1" class="buttonColor" OnClick="Submit_Click" runat="server" Text="Update"></asp:Button>
                </div>
            </div>
