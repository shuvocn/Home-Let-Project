...
public partial class Dashboard : System.Web.UI.Page
{
    ...
    public void datalist()
    {
        try
        {
            MySqlDataAdapter da = new MySqlDataAdapter("select * from add_property order by p_id desc", con);
    ...
    protected void deleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        con.Open();
        MySqlDataAdapter sda = new MySqlDataAdapter("DELETE FROM add_property WHERE p_id='"+Id_No.Text+"' ", con);
