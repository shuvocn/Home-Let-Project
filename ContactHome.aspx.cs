...
public partial class Default2 : System.Web.UI.Page
{
    ...
    {
        con.Open();
        MySqlDataAdapter sda = new MySqlDataAdapter("INSERT INTO contact_us(c_name,c_email,c_massage) values ('" + ContactName.Text + "','" + ContactEmail.Text + "','" + ContactMassage.InnerText + "')", con);
        try
        {
